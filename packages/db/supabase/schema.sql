...
CREATE INDEX idx_builds_started_at ON public.builds(started_at DESC);
...
CREATE INDEX idx_artifacts_build_id ON public.build_artifacts(build_id);
CREATE INDEX idx_artifacts_type ON public.build_artifacts(artifact_type);
...
CREATE INDEX idx_logs_build_id ON public.build_logs(build_id);
CREATE INDEX idx_logs_timestamp ON public.build_logs(timestamp DESC);
CREATE INDEX idx_logs_level ON public.build_logs(level);
